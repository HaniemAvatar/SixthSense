...
public class AlarmListAdapter extends BaseAdapter {
	...
	public static final String ALARM_FIELDS[] = { Database.COLUMN_ALARM_ACTIVE,
			Database.COLUMN_ALARM_TIME, Database.COLUMN_ALARM_LEDPICKS };
	...
	public View getView(int position, View view, ViewGroup viewGroup) {
		...
		alarmTimeView.setText(alarm.getAlarmTimeString());
			...
			alarmDaysView.setText(alarm.getLEDPicksString());		

		return view;
	}

	public List<Alarm> getLEDAlarms() {
		return alarms;
	}

	public void setLEDAlarms(List<Alarm> alarms) {
		this.alarms = alarms;
	}
